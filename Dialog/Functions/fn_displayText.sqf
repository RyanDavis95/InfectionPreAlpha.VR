...
_alignBottom	= _this param [3, true, [false]];
_rootFormat 	= _this param [4, "<t >%1</t>", [""]];
_abortParams 	= _this param [5, [], [[]]];
_abortCond 	= _this param [6, {false}, [{}]];
...
{
	_block 	= _x param [0, "", [""]];
	_format = _x param [1, "align = 'center' size = '0.7'", [""]];
	_color	= _x param [2, "#ffffff", [""]];
...
[_frames select 0, 0, 0, 10e10, 0, 0, 90] spawn BIS_fnc_dynamicText;
